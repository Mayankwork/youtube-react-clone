...
const commentsData = [
  {
    name: "Mayank",
    text: "Lorem ipsum some thing heris the comments",
    replies: [],
  },
  {
    name: "Mayank",
...
const CommentsList = ({comments})=>{
    ...
    return comments.map((comment,index)=> (
        <div key={index}  className=" border-2 m-1 p-1">
...
const Comment = ({data}) => {
  ...
  return (
    <div className="flex bg-gray-300 rounded-full p-1 mt-1">
      <img
...
const CommentsContainer = () => {
  return (
    <div className="m-5 p-2">
      <h1 className="font-bold text-xl">Nested Comments :-</h1>
