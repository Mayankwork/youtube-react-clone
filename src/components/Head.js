    ...
    <div className="grid grid-flow-col p-3 m-2 shadow-lg">
      <div className="flex col-span-1">
        <img
          ...
          alt="hammenu"
          src="https://icons-for-free.com/download-icon-hamburger+button-1324760585124590953_512.png"
        />
        <a href="/">
          <img
            className="h-7 mx-2"
      ...
      <div className="flex col-span-10 ">
        ...
        {showSuggestions && (
          <div
            style={{ width: "465px" }}
            className="fixed bg-white mt-11 mx-4 rounded-lg shadow-lg "
          >
            <ul>
              {suggestions.map((s) => {
                return (
                  <li key={s} className="px-4 shadow-sm hover:bg-gray-100">
